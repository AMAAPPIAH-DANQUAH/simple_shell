...
/**
 * cd_dot -  Main directory.
 *
 * @datash: Main data structure.
 *
...
/**
 * cd_previous - Transmute to precursory directory.
 *
 * @datash: Main data structure.
 *
 * Return: No return value.
...
/**
 * cd_to_home - Transmute to directory.
 *
 * @datash: Main data structure.
 *
 * Return: No return value.
